import { Icon } from "@talkjs/react-components";
import type { ReplyBarProps } from "@talkjs/react-components";
...
export function ReplyBar(props: ReplyBarProps) {
  ...
  return (
    <div className="t-theme-reply-bar">
      <Icon className="t-reply-icon" type="reply" size={20} />
      ...
      >
        <Icon className="t-close-icon" type="close" size={24} />
      </button>
    </div>
  );
}
