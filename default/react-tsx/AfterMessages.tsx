...
import type { AfterMessagesProps, TypingSnapshot } from "@talkjs/react-components";

/**
 * AfterMessages is rendered inside the message list container, after the last message.
 */
export function AfterMessages({ common }: AfterMessagesProps) {
  ...
  return (
    ...
    >
      <div className="t-typing-avatars" aria-hidden="true">
        {avatars}
        {!typing.many && typing.users.length > 2 && (
...
function makeAriaLabel(typing: TypingSnapshot) {
  if (typing.many) {
